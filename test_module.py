...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_percentage_bachelors(self):
        ...
        expected = 16.4 
        self.assertAlmostEqual(actual, expected, 1, msg="Expected different value for percentage with Bachelors degrees.")

    def test_higher_education_rich(self):
        actual = self.data['higher_education_rich']
        expected = 46.5
        self.assertAlmostEqual(actual, 1, expected, msg="Expected different value for percentage with higher education that earn >50K.")
  
    def test_lower_education_rich(self):
        actual = self.data['lower_education_rich']
        expected = 16
        self.assertAlmostEqual(actual, expected, 1, msg="Expected different value for percentage without higher education that earn >50K.")
